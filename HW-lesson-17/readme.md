...
После установки модуля для изменения политики SE Linux, выполняем удаленное внесение изменений в зону ddns.lab. При внесении изменений формируется ошибка - 
