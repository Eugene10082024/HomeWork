...
##### 3.1.4. Проверка работы ноды кластера и создание самого кластера.
...
#### 3.2. Добавлнение второй ноды (astra-patroni02 - 192.168.122.104) в кластер etcd.

##### 3.2.1. Добавление второй ноды (astra-patroni02 - 192.168.122.104) в список кластера.
